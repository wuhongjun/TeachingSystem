...
<html>
  <head>
    ...
    <title>My JSP 'teacCourse.jsp' starting page</title>
	...
	-->
	<link rel="stylesheet" type="text/css" href="../css/teacCourse.css">
  </head>
 	 ...
 	 <%@include file="public.jsp"%>
  		<div id="mainBody">
    		<div id="left">
	  			...
	  			<div class="search" style="float:right;margin-right:50px;margin-top:10px;font-size:14px;">课程检索：<input type="text" name="courseName"><input type="button" value="搜索" onclick="" style="margin-left:10px;"></div>
	  			<div style="text-indent: 60px;padding-top:20px;">
	  				<ul>
	  				...
	  				<div style="margin-top:20px;margin-left:600px;"><a href="../jsp/allCourse.jsp">more...</a></div>
	  			</div>
	  		</div>
  </body>
</html>
